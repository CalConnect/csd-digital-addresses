...
The address profile model defined in this standard consists of three major
layers: the AddressProfile model as a container of profiles of addresses and
address components, the profiles of addresses and address components, and
...
components MUST conform to their corresponding AddressClassProfiles and
AddressComponentProfiles. The association between an address and an address
components MUST also conform to the AddressComponentSpecification defined in
...
This standard further defines InterchangeAddressClassProfile for defining
AddressClassProfiles which can be claimed as interchangeable. Addresses
